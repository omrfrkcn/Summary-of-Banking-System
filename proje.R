...
sub_data[, AnnualChange := (Variable - lag(Variable, n = 12))/lag(Variable, n = 12)*100]
head(sub_data,20)
...
sub_data2[, AnnualChange2 := (Variable2 - lag(Variable2,n = 12))/lag(Variable2, n = 12)*100]
head(sub_data2,20)
...
sub_df[, Consumer_change := (Consumer - lag(Consumer, n = 12))/lag(Consumer,n = 12)*100]
sub_df[, Housing_change := (Housing - lag(Housing, n = 12))/lag(Housing, n = 12)*100]
sub_df[, Automobile_change := (Automobile - lag(Automobile, n = 12))/lag(Automobile,n = 12)*100]
...
all_data_long[c(72:576),][Variable == "Dolarizasyon"]
...
DT[, l_consumer_interest :=lag(Consumer_interest,n = 3)]
DT[, l_commercial_interest :=lag(Commercial_interest,n = 3)]
DT[, l_consumer_growth :=lag(Consumer_growth,n = 3)]
DT[, l_commercial_growth :=lag(Commercial_growth,n = 3)]
DT[, l_credit_growth :=lag(credit_growth,n = 3)]
...
ggplot(DT2, aes(x=credit_growth, y=GDP)) + geom_point() + 
